...
for line in sys.stdin:
    ...
    try:
        cur.execute(
            "INSERT INTO contagens(data_e_hora, localidade, tipo, contagem, autuacoes,placas) VALUES (%s, %s, %s, %s, %s, %s)",
        ...
        conn.rollback()
        cur.execute(
            "update contagens set contagem=contagen+%s, autuacoes=autuacoes+%s, placas=placas+%s where data_e_hora=%s and localidade=%s and tipo=%s",
